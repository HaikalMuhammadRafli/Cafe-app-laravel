...
class KasirPelangganController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('kasir.pelanggan.index', $data)->with('no', ($request->input('page', 1) - 1) * 20);
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('kasir.pelanggan.edit', $data);
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        if ($user->update($input)) {
            return redirect()->route('pelanggan-kasir.index')->with('success', 'User berhasil diedit!');
        } else {
            return redirect()->route('pelanggan-kasir.index')->with('error', 'Something went wrong!');
        }
    }
