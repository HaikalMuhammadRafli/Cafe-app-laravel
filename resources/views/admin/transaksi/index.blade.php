...
@section('content')
    <div class="container-fluid">
        <div class="admin-transaksi-index-main" id="main">
                    ...
                    <tbody>
                        @foreach ($transaksis as $transaksi)
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <a href="{{ route('transaksi.show', $transaksi->id) }}" class="btn btn-primary me-2">Details</a>
                                        @if ($transaksi->status == 'Menunggu Pembayaran')
                                            <a href="{{ route('transaksi.bayar', $transaksi->id) }}" class="btn btn-success me-2">Bayar</a>
