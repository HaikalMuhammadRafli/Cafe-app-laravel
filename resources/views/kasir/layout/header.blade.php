<nav class="navbar navbar-expand-lg fixed-top shadow">
    <div class="container-fluid" id="navbar-main">
        ...
        <a href="{{ route('kasir.dashboard') }}" class="navbar-brand">Kendedes Cafe</a>
...
<div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="offcanvas" aria-labelledby="offcanvas">
    <div class="offcanvas-header">
        <h5 class="offcanvas-title" id="offcanvas-label">Kasir Dashboard</h5>
        <button class="btn-close" type="button" data-bs-dismiss="offcanvas" aria-label="Close"></button>
    </div>
    <div class="offcanvas-body d-flex flex-column">
        <a href="{{ route('pelanggan-kasir.index') }}" class="btn btn-secondary mb-2">Pelanggan</a>
        <a href="{{ route('meja-kasir.index') }}" class="btn btn-secondary mb-2">Meja</a>
        <a href="{{ route('transaksi-kasir.index') }}" class="btn btn-secondary mb-2">Transaksi</a>
        <a href="{{ route('kasir.laporan') }}" class="btn btn-secondary mb-2">Laporan</a>
    </div>
</div>